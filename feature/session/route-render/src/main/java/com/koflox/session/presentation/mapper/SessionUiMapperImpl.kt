...
import com.koflox.session.statsdisplay.R
import java.text.SimpleDateFormat
import java.util.Date
import java.util.Locale

class SessionUiMapperImpl(
    ...
    private fun formatCompletedStatValue(
        ...
        SessionStatType.CALORIES_POWER -> {
            ...
            if (session.hasPowerData && totalEnergyJoules != null) {
                context.getString(R.string.session_stat_value_kcal, formatCalories(totalEnergyJoules / JOULES_PER_KCAL))
            } else {
                UNAVAILABLE_VALUE
            }
        }
