...
class ShareViewModelTest {
    ...
    companion object {
        ...
        private val SHARE_ERROR_UI_TEXT = UiText.Resource(com.koflox.session.share.R.string.share_image_processing_error)
        private val GPX_ERROR_UI_TEXT = UiText.Resource(com.koflox.session.share.R.string.gpx_export_file_error)
    ...
    private val savedStateHandle = SavedStateHandle(mapOf(ShareViewModel.SESSION_ID_ARG to SESSION_ID))
    ...
    private fun setupDefaultMocks() {
        every { sessionUiMapper.toSessionUiModel(any()) } returns SessionUiModel(
