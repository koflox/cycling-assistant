...
internal fun ImageShareTab(
    ...
    Column(
        ...
        ShareActionRow(
            ...
            onEditStatsClick = { onNavigateToStatsConfig(StatsDisplaySection.SHARE.name) },
        )
    }
}
        ...
        if (onEditStatsClick != null) {
            IconButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(StatsR.string.stats_config_edit_content_description),
...
@Composable
internal fun SharePreviewContent(
    data: SharePreviewData,
    onMapLoaded: () -> Unit,
    modifier: Modifier = Modifier,
) {
    Surface(
        ...
        Column {
            Box(
                ...
                MapHeaderOverlay(
                    title = data.destinationName ?: stringResource(R.string.share_free_roam_title),
