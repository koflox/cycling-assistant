 ...
 * V2 — Basic filtering.
 *
 * Introduced GPS accuracy validation (≤ 20 m), a minimum displacement
 * threshold (5 m) to suppress GPS jitter, a maximum speed cap (100 km/h)
 * to reject teleport-like outliers, and altitude gain tracking.
 * Coordinates are still used raw — no Kalman smoothing, no speed smoothing.
 */
internal class V2FilteredComparisonLocationProcessor(
    ...
    companion object {
        ...
        private const val VERSION_LABEL = "V2 Filtered"
    }
