...
include(":feature:bridge:session-strava:api")
include(":feature:bridge:session-strava:impl")
include(":feature:connections")
include(":feature:dashboard")
include(":feature:destinations")
include(":feature:integrations:strava:api")
include(":feature:integrations:strava:impl")
