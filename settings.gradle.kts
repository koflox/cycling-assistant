...
include(":feature:session:completion")
include(":feature:session:data")
include(":feature:session:domain")
include(":feature:session:history")
include(":feature:session:init")
include(":feature:session:nav-graph")
include(":feature:session:route-render")
include(":feature:session:share")
include(":feature:session:stats-display")
include(":feature:session:tracking")
...
include(":shared:id")
include(":shared:init")
include(":shared:location:data")
include(":shared:location:domain")
include(":shared:map")
